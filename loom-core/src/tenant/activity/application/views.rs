...
impl ActivityView {
    pub fn new(
        ...
        Self { id, project_id, name, comment, visible, billable }
    }

    pub fn get_id(&self) -> &ActivityId { &self.id }
    pub fn get_project_id(&self) -> Option<&ProjectId> { self.project_id.as_ref() }
